...
* plugins: bootstrap-transition.js, bootstrap-dropdown.js, bootstrap-tooltip.js, bootstrap-carousel.js
...
$(document).ready(function(){$('.carousel').carousel('pause');$(".partner_tooltip").tooltip({placement: 'right'});$('.location_image').tooltip();$('.dropdown-toggle').dropdown()});